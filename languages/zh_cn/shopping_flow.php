...
$_LANG['flow_no_shipping'] = '您必须选定一个交易方式。';
...
$_LANG['flow_js']['shipping_not_null'] = '请您选择交易方式！';
...
$_LANG['new_consignee_address'] = '新收货信息';
$_LANG['consignee_address'] = '收货信息';
...
$_LANG['city'] = '城市';
$_LANG['area'] = '所在区域';
$_LANG['consignee_add'] = '添加新收货信息';
$_LANG['shipping_address'] = '配送至此交易';
$_LANG['address_amount'] = '您的收货信息最多只能是三个';
$_LANG['not_fount_consignee'] = '对不起，您选定的收货信息不存在。';
...
$_LANG['select_shipping'] = '您选定的交易方式为';
