...
$_LANG['game_nickname'] = '游戏角色名称';
$_LANG['game_level'] = '游戏角色等级';
$_LANG['game_jueseid'] = '游戏角色ID号';
$_LANG['game_zhiye'] = '游戏角色职业';
$_LANG['game_wushi'] = '(充值卡类可不填)';

$_LANG['search_ship'] = '查看支持的交易方式';

$_LANG['del_address_false'] = '删除收货信息失败！';
$_LANG['add_address_success'] = '添加新信息成功！';
$_LANG['edit_address_success'] = '您的收货信息信息已成功更新！';
$_LANG['address_list_lnk'] = '返回收货列表';
$_LANG['add_address'] = '新增收货信息';
$_LANG['confirm_edit'] = '确认修改';

$_LANG['confirm_drop_address'] = '你确认要删除该收货信息吗？';
...
$_LANG['shipping_not_need'] = '无需使用交易方式';
...
$_LANG['merge'] = '合并';
$_LANG['notice_order_sn'] = '当两个订单不一致时，合并后的订单信息（如：支付方式、交易方式、包装、贺卡、红包等）以第二个为准。';
$_LANG['subtotal'] = '小计';
