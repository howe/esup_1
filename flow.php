...
elseif ($_REQUEST['step'] == 'consignee')
{
    ...
    else
    {
        ...
        $consignee = array(
            ...
            'consignee'     => empty($_POST['consignee'])  ? trim($_POST['game_nickname']) : trim($_POST['consignee']),
            'country'       => empty($_POST['country'])    ? '1' : $_POST['country'],
            'province'      => empty($_POST['province'])   ? '2' : $_POST['province'],
            'city'          => empty($_POST['city'])       ? '52' : $_POST['city'],
            'district'      => empty($_POST['district'])   ? '500' : $_POST['district'],
			...
			'game_nickname'       => empty($_POST['game_nickname'])    ? '' : $_POST['game_nickname'],
			'game_level'       => empty($_POST['game_level'])    ? '' : $_POST['game_level'],
			'game_jueseid'       => empty($_POST['game_jueseid'])    ? '' : $_POST['game_jueseid'],
			'game_zhiye'       => empty($_POST['game_zhiye'])    ? '' : $_POST['game_zhiye'],
        );
