...
else
{
    ...
    $sql   = "SELECT COUNT(*) FROM " .$ecs->table('goods'). " AS g ".
        "WHERE g.is_delete = 0 AND g.is_on_sale = 1 AND g.goods_number > 0 AND g.is_alone_sale = 1 $attr_in ".
    ...
    /* 查询商品 */
    $sql = "SELECT g.goods_id, g.yxm, g.yxqm, g.zhenying,g.goods_number, g.yxfm, g.danwei, g.danjia, g.goods_name, g.market_price, g.is_new, g.is_best, g.is_hot, g.shop_price AS org_price, ".
