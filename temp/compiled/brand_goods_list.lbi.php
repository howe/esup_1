...
?><?php if ($this->_var['option']['rewrite'] == '0'): ?>&<?php else: ?>?<?php endif; ?>display=list#goods_list" title="<?php echo $this->_var['lang']['display_list']; ?>" class="dp_list<?php if ($this->_var['pager']['display'] == 'list'): ?> dp_list_current<?php endif; ?>"><?php echo $this->_var['lang']['display_list']; ?></a>
        -->
		<a href="<?php 
$k = array (
  'name' => 'build_uri',
...
?><?php if ($this->_var['option']['rewrite'] == '0'): ?>&<?php else: ?>?<?php endif; ?>display=text#goods_list" title="<?php echo $this->_var['lang']['display_text']; ?>" class="dp_text<?php if ($this->_var['pager']['display'] == 'text'): ?> dp_text_current<?php endif; ?>"><?php echo $this->_var['lang']['display_text']; ?></a>
		</p>
		<?php endif; ?>
	</div>
</div>
<div class="box" id="goods_list">
	<div class="hd"><h3><?php echo $this->_var['lang']['goods_list']; ?></h3><div class="mode"></div></div>
...
?>
			...
			<li<?php if ($this->_var['pager']['display'] == 'grid'): ?><?php if (($this->_foreach['goods_list']['iteration'] - 1) % 4 == 0): ?> class="first_child"<?php endif; ?><?php elseif ($this->_var['pager']['display'] == 'list'): ?><?php if (($this->_foreach['goods_list']['iteration'] - 1) % 2 == 0): ?> class="first_child"<?php endif; ?><?php elseif ($this->_var['pager']['display'] == 'text'): ?><?php if (($this->_foreach['goods_list']['iteration'] <= 1)): ?> class="first"<?php endif; ?><?php endif; ?> data="id:'<?php echo $this->_var['goods']['goods_id']; ?>'">
				...
				<span class="info">
					...
					<em class="price"><?php if ($this->_var['goods']['promote_price']): ?><?php echo $this->_var['goods']['promote_price']; ?><?php else: ?><?php echo $this->_var['goods']['shop_price']; ?><?php endif; ?>&nbsp;&nbsp;&nbsp;&nbsp;<font color="#333333"><?php echo $this->_var['lang']['list_fs']; ?></font><?php echo $this->_var['goods']['goods_number']; ?></em><?php if ($this->_var['goods']['promote_price']): ?><span class="promo" title="<?php echo htmlspecialchars($this->_var['goods']['shop_price']); ?> &gt; <?php echo htmlspecialchars($this->_var['goods']['promote_price']); ?>"><?php echo $this->_var['lang']['sale']; ?></span><?php endif; ?>
                 <?php if ($this->_var['goods']['type'] == "10"): ?>
                    <em><?php echo $this->_var['lang']['list_danjia']; ?><?php echo $this->_var['goods']['danjia']; ?>&nbsp;<font color="#FF3333"><?php echo $this->_var['lang']['huobi_rmb']; ?>/<?php echo $this->_var['goods']['danwei']; ?></font></em><?php endif; ?>
