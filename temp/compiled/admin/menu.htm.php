...
//初始化菜单状态
ToggleHanlder.Load();
Ajax.call('index.php?is_ajax=1&act=menu_api','', start_menu_api, 'GET', 'TEXT','FLASE');
function start_menu_api(result)
{
  if(result)
  {
    document.getElementById("menu-ul").innerHTML = document.getElementById("menu-ul").innerHTML + result;     
  }
}
//-->
</script>
