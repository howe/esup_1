    ...
    if (isset($_POST['confirm']))
    {
		...
		elseif (isset($_POST['to_shipping']))
		{
		   ...
		   if (!empty($invoice_no))
			...
			$delivery['game_nickname'] = trim($order['game_nickname']);
			$delivery['game_level'] = trim($order['game_level']);
			$delivery['game_jueseid'] = trim($order['game_jueseid']);
			$delivery['game_zhiye'] = trim($order['game_zhiye']);
